...
class DetailsAdapter(private var currencyList: List<Pair<String, CurrencyDetails>>) :
    RecyclerView.Adapter<DetailsAdapter.ViewHolder>() {

    inner class ViewHolder(val binding: CurrencyItemDetailsLayoutBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = CurrencyItemDetailsLayoutBinding.inflate(
